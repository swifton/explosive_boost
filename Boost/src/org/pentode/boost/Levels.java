...
public class Levels {
	...
	public Levels() {
		...
		level2.detector = new Detector(15, 30, 1);		
		...
		level4.detector = new Detector(43, 15, 2);
		...
		level5.detector = new Detector(43, 1, 3);
		...
		level6.detector = new Detector(43, 30, 2);
		...
		level7.detector = new Detector(43, 30, 2);
		...
		level8.detector = new Detector(43, 10, 2);
		...
		level9.detector = new Detector(43, 20, 0);
		...
		level10.detector = new Detector(43, 30, 2);
		...
		level11.detector = new Detector(43, 2, 3);
		...
		level12.detector = new Detector(15, 1, 1);	
		...
		level13.detector = new Detector(1, 30, 1);
		...
		level14.detector = new Detector(1, 20, 2);
		...
		level15.detector = new Detector(1, 1, 1);
	}
